...
function useImageResize() {
    var _this = this;
    var _a = useState(false), isResizing = _a[0], setIsResizing = _a[1];
    ...
    var resizeImageFile = useCallback(function (file, options) {
...
export { useBuildQueryString, useClipboard, useDualStateController, useForm, useImageResize, usePagination as usePaginationState, useProcessing };
