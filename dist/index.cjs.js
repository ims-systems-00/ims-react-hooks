...
function useForm(initdataModel, schema) {
    var _this = this;
    var _a = React.useState(initdataModel), dataModel = _a[0], setDataModel = _a[1];
    var _b = React.useState({}), validationErrors = _b[0], setValidationErrors = _b[1];
    var _c = React.useState(false), isBusy = _c[0], setIsBusy = _c[1];
